export const navigationItems = ['Home', 'Generative AI', 'Solutions', 'Industry', 'Services', 'Success Stories', 'Company']
...
export const companyItems = [
  { label: 'Contact Us', href: '/contact-us', icon: 'M3 5h18v14H3z m0 1 9 7 9-7' },
...
export function navigationHref(label: string) {
  ...
  if (label === 'Success Stories') return '/customer-success-stories'
